...
class student:
    def __init__(self, config):
        ...
        linear_output_21 = tf.nn.relu(tf.nn.rnn_cell._linear(linear_output, int(self.output_embed.get_shape()[2]), 1.0, 0.01, scope="linearN21"))
        linear_output_22 = tf.nn.relu(tf.nn.rnn_cell._linear(linear_output, int(self.output_embed.get_shape()[2]), 1.0, 0.01, scope="linearN22"))
        linear_output_23 = tf.nn.relu(tf.nn.rnn_cell._linear(linear_output, int(self.output_embed.get_shape()[2]), 1.0, 0.01, scope="linearN23"))
