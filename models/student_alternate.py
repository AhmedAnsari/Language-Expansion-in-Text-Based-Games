...
class student:
    def __init__(self, config):
        ...
        self.action_value_ = tf.pack([self.action_value_1,self.action_value_2,self.action_value_3],2)
        self.object_value_ = tf.pack([self.object_value_1,self.object_value_2,self.object_value_3],2)
        ...
        self.pred_action_prob_1 = tf.nn.softmax(self.action_value)
        self.pred_object_prob_1 = tf.nn.softmax(self.object_value)
